...
export function UnifiedBatchActionBar({
  ...
  return (
    <div
      className={cn(
        "absolute bottom-3 inset-x-3 z-30 flex items-center justify-between gap-1.5 rounded-xl border border-border/80 bg-background/95 backdrop-blur-md px-3 py-1.5 shadow-lg text-xs animate-in fade-in slide-in-from-bottom-2",
        className,
      )}
    >
      {/* Compteur & sélection */}
        ...
        {isPending ? (
          ...
          <>
            ...
            <Button
              variant="ghost"
              size="icon-xs"
              title="Marquer comme indésirable"
