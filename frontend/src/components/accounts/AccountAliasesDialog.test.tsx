...
describe("AccountAliasesDialog", () => {
  ...
  it("affiche l'adresse principale et les alias configurés", () => {
    ...
    expect(
      screen.getByText("Jean Dupont <principal@mailora.me>"),
    ).toBeInTheDocument();
    expect(screen.getByText("support@mailora.me")).toBeInTheDocument();
    expect(screen.getByText("direction@mailora.me")).toBeInTheDocument();
  ...
  it("permet d'ouvrir le formulaire d'ajout et d'ajouter un alias", async () => {
    ...
    await userEvent.type(emailInput, "commercial@mailora.me");
